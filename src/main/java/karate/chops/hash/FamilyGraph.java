...
class FamilyGraph {
    ...
    private static FamilyResults findNodesWithZeroAndOneParents(int[][] parentChildPairs) {
        Map<Integer, List<Integer>> familyMap = createFamilyMap(parentChildPairs);
    ...
    private static boolean hasCommonAncestor(int[][] parentChildPairs, int p1, int p2) {
        Map<Integer, List<Integer>> familyMap = createFamilyMap(parentChildPairs);
        return getIntersection(findAncestor(familyMap, p1), findAncestor(familyMap, p2));
    }

    private static Map<Integer, List<Integer>> createFamilyMap(int[][] parentChildPairs) {
